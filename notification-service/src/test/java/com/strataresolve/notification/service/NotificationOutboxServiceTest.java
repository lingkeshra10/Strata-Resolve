...
class NotificationOutboxServiceTest {
    ...
    void shouldCreateNotificationWithCorrectFields() {
        ...
        assertThat(saved.getPropertyId())
                .isEqualTo(propertyId);

        assertThat(saved.getRecipientUserId())
                .isEqualTo(recipientUserId);

        assertThat(saved.getRecipientEmail())
                .isEqualTo(recipientEmail);

        assertThat(saved.getTicketId())
                .isEqualTo(ticketId);

        assertThat(saved.getEventType())
                .isEqualTo(eventType);

        assertThat(saved.getSubject())
                .isEqualTo(subject);
