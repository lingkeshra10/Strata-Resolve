...
public class BlockService {
    ...
    public Block update(UUID blockId, UUID propertyId, UpdateBlockRequest request, UUID actingUserId) {
        Block block = findByIdOrThrow(blockId, propertyId);
    ...
    private Block findByIdOrThrow(UUID blockId, UUID propertyId) {
        return blockRepository.findByIdAndPropertyId(blockId, propertyId)
                .orElseThrow(() ->
                        new ResourceNotFoundException("Block", blockId));
    }
